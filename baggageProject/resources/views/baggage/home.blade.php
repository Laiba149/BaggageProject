    ...
    <div style="background-color: rgb(121, 218, 243); font-size: small;">
        ...
        <div class="container">
            <div class="row" style="display: flex;">
                <div class="col-lg-5 "
                    style=" padding-right: 8px; padding-top: 150px; text-transform: uppercase; letter-spacing: 1px; font-size: larger;">
                    <h2>The Largest Range
                        <span style="color: #ffffff;">of<br> HandBags</span>
                    </h2>
                    <a href=""
                        style="background-color: red; color: #ffffff; padding: 10px 25px; text-transform: uppercase; font-size: small; text-decoration: none; margin: 8px 10px;"><b>SHOP
                            NoW</b></a>
                </div>
