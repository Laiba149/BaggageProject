...
<body>
    ...
    <form action="{{route('baggage.checkout')}}" method="post" style="margin-top:20px">
        @csrf
        ...
        <button style="background:#6fb3c1; color: white;padding: 8px 18px;border: none;border-radius: 5px;font-size: 15px;" >submit</button>
